...
<div class="col-lg-9 mt-2">
    <!--Merubah kolom menjadi 9 agar lebih besar dari kolom pertama-->
    <div class="card">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_input_user.php"
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" id="floatingInput"
                                                    placeholder="08xxxxxxxx" name="nohp" required>
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" style="heigh:100px" name="alamat"></textarea>
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_user.php"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <select disabled class="form-select" arial-label="Default select example"
                                ...
                                <div class="form-floating">
                                    <textarea disabled class="form-control" style="heigh:100px"
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_edit_user.php"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <select class="form-select" arial-label="Default select example" required
                                                name="level" id="">
                                                <?php
                                        $data = array("Owner/Admin", "Kasir", "Pelayan", "Dapur");
                                        foreach($data as $key => $value) {
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" style="heigh:100px"
                                        name="alamat"><?php echo $row['alamat']?></textarea>
                                    <label for="floatingInput">Alamat</label>
                                </div>
                                <div class="modal-footer">
                            ...
                            <form class="needs-validation" novalidate action="proses/proses_reset_password.php"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-success" name="input_user_validate"
                                        value="12345"
                                        <?php echo ($row['username'] == $_SESSION['username_decafe']) ? 'disabled' : '' ;?>>Reset Password</button>
                                </div>
                            </form>
                        </div>
